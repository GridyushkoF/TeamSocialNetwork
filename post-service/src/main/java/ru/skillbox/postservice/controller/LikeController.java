...
public class LikeController {
    ...
    public void likePost(@PathVariable("id") Long postId, HttpServletRequest request) {
    ...
    public void unLikePost(@PathVariable("id") Long postId, HttpServletRequest request) {
        Long currentAuthUserId = Long.parseLong(request.getHeader("id"));
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public void likeComment(@PathVariable("id") Long postId, @PathVariable("commentId") Long commentId, HttpServletRequest request) {
        Long currentAuthUserId = Long.parseLong(request.getHeader("id"));
    ...
    @ResponseStatus(HttpStatus.OK)
    public void unLikeComment(@PathVariable("id") Long postId, @PathVariable("commentId") Long commentId, HttpServletRequest request) {
        Long currentAuthUserId = Long.parseLong(request.getHeader("id"));
